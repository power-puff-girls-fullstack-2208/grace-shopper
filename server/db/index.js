...
const syncAndSeed = async () => {
    ...
    const usersExample = await User.bulkCreate([{id:1,username:"cplace0",password:"WvUcrbJTJg5Z",email:"cplace0@house.gov",fName:"Connie",lName:"Place"},
    ...
    const productsExample = await Product.bulkcreate([{Id:"QWn-15",price:"$7.25",qty:"59",img:"https://robohash.org/etquiset.png?size=50x50&set=set1",
    descr:"Etiam pretium iaculis justo. In hac habitasse platea dictumst. Etiam faucibus cursus urna. Ut tellus. Nulla ut erat id mauris vulputate elementum.",name:"Springbuck"},
      {Id:"IcH-44",price:"$8.62",qty:"4705",img:"https://robohash.org/errornesciuntrepudiandae.png?size=50x50&set=set1",descr:"Cras mi pede, malesuada in, imperdiet et, commodo vulputate, justo. In blandit ultrices enim. Lorem ipsum dolor sit amet, consectetuer adipiscing elit.",
      name:"Currasow (unidentified)", tagId: tagsExample.id},
      {Id:"EYg-65",price:"$1.28",qty:"2",img:"https://robohash.org/delenitiipsamvel.png?size=50x50&set=set1",
      ...
      {Id:"dTD-02",price:"$1.15",qty:"84",img:"https://robohash.org/itaqueanimiveniam.png?size=50x50&set=set1",
      ...
      {Id:"vxL-70",price:"$5.72",qty:"672",img:"https://robohash.org/errornihilenim.png?size=50x50&set=set1",
      ...
      {Id:"9gF-39",price:"$4.00",qty:"6",img:"https://robohash.org/inventoremaiorestotam.png?size=50x50&set=set1",
      ...
      {Id:"VzS-63",price:"$7.74",qty:"7","imag":"https://robohash.org/remvitaeiusto.png?size=50x50&set=set1",
      ...
      {Id:"bKv-09",price:"$6.22",qty:"00507",img:"https://robohash.org/sedquiest.png?size=50x50&set=set1",
      ...
      {Id:"4tF-74",price:"$9.37",qty:"2",img:"https://robohash.org/hicasperioresvoluptatem.png?size=50x50&set=set1",
      ...
      {Id:"MEA-75",price:"$0.78",qty:"1668",img:"https://robohash.org/aperiamquamin.png?size=50x50&set=set1",
    ...
    const ordersExample = await Order.bulkCreate([{isCart:false,address:"044 Holy Cross Trail"},
      {isCart:false,address:"1311 Utah Lane"},
      {isCart:false,address:"05990 Northfield Trail"},
      {isCart:false,address:"64 Sachs Trail"},
      {isCart:false,address:"326 Armistice Crossing"},
      {isCart:false,address:"13723 Hagan Hill"},
      {isCart:false,address:"77 Nova Road"},
      {isCart:false,address:"3 Messerschmidt Center"},
      {isCart:false,address:"4 Dapin Street"},
      {isCart:true,address:"123 Esch Lane"}]);

    const tagsExample = await Tag.create({subtype:['pokemon'], type:['normal'], rarity: 'common'});

    const lineItemExample = await LineItem.bulkCreate([{quantity: 0, productId: productsExample[0].Id},{quantity: 0, productId: productsExample[0].Id},
      {quantity: 0, productId: productsExample[0].Id},{quantity: 0, productId: productsExample[0].Id},{quantity: 0, productId: productsExample[0].Id},
      {quantity: 0, productId: productsExample[0].Id },{quantity: 0, productId: productsExample[0].Id}, {quantity: 0, productId: productsExample[0].Id},
      {quantity: 0, productId: productsExample[0].Id},{quantity: 0, productId: productsExample[0].Id},]);
